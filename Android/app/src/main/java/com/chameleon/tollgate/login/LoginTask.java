...
public class LoginTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public LoginTask(Context context, Handler handler, String pwd, long timestamp) {
    ...
    protected Boolean doInBackground(Void... params) {
        RestConnection rest = new RestConnection(this.context, Path.LOGIN, Method.GET);
        rest.putParam("pwd", this.pwd);
