...
namespace AuthClient.tollgate.otp.service
{
    class OtpService
    {
        internal string PostOtpRegister(in string id)
        {
            // 통신 TimeStamp
        ...
        internal string PostOtpVerify(in string id, in string InputOtpData)
        {
            // 통신 TimeStamp
            long currentTimestamp = Util.GetCurrentTimestamp();

            // DTO 준비
            AuthOtp authotp = new AuthOtp(id, currentTimestamp,InputOtpData);
